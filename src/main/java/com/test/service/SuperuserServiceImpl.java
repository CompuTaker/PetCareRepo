...
public class SuperuserServiceImpl implements SuperuserService {
	...
	public String getAdmin(HttpServletRequest request) {
		...
		superuser.put("id", request.getParameter("username")); // Map객체에 아이디를 저장한다.
		superuser.put("pw", request.getParameter("password")); // Map객체에 비밀번호를 저장한다.
		System.out.println(superuser.get("id"));
		System.out.println(superuser.get("pw"));
		...
		if (superuserDto != null) { // superuser가 존재하는 경우
			System.out.println("~~~" + superuserDto.getUsername());
