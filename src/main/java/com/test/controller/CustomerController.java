...
@Controller // Spring�씠 �빐�떦 �겢�옒�뒪媛� Controller�씤 嫄� �븣�젮二쇰뒗 Annotation
...
public class CustomerController {
	...
	public Object customer_signupDo(@RequestParam HashMap<String, Object> cmap,
			MultipartHttpServletRequest multipartHttpServletRequest, HttpServletRequest request, Model model) { // form�뿉�꽌
																												// �엯�젰�븳
																												// 媛믪쓣
																												// HashMap�쑝濡�
																												// 臾띠뼱�꽌
		...
		if (request.getParameter("mobile") != null) {
			System.out.println("紐⑤컮�씪�엯�땲�떎.");
