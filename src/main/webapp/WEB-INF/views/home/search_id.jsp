		...
		<div class="container">
			...
			<div class="custom-control custom-radio custom-control-inline">
				<input type="radio" class="custom-control-input" id="search_2"
					...
					class="custom-control-label" for="search_2">일반회원</label>
			</div>
			...
			<div id="searchP" style="display: none;" for="search_check(2)">
				<form action="search_id_customer" method="POST">
					<label for="Customer_Name">이름</label> <input type="text"
						...
						name="customer_Name" required /> <label
						for="customer_PhoneNumber">핸드폰 번호</label> <input type="text"
						class="form-control" id="customer_PhoneNumber"
						placeholder="010-1234-5678" name="customer_PhoneNumber" required />
					<button type="submit" class="btn btn-primary">확인</button>
				</form>
