  ...
  <body>
    <header>
      <nav class="menu navbar navbar-expand-lg navbar-light" id="top">
        ...
        <button
          class="navbar-toggler mainheader"
          type="button"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="admin_login">관리자</a>
            </li>
          </ul>

          <form class="menu_form form-inline my-2 my-lg-0">
            <input
              class="menu_form_input form-control mr-sm-2"
              type="search"
              placeholder="검색"
              aria-label="Search"
            />
            <button
              class="menu_form_btn btn btn-outline-success my-2 my-sm-0"
              type="submit"
            >
