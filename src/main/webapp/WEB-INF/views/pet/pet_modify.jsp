		...
		<form action="pet_modify" class="pet_modify" name="modify" method="post">
			...
			<div class="form-group row">
				...
				<div class="gender-radio-group col-sm-8">
					<input type="radio" name="pet_Gender" value="암컷" <c:if
						test="${pet.pet_Gender eq '암컷'}">checked="checked"</c:if>>암컷
					<input type="radio" name="pet_Gender" value="수컷" <c:if
						test="${pet.pet_Gender eq '수컷'}">checked="checked"</c:if>>수컷
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 col-form-label" for="pet_Age">나이(개월수)</label>
				<div class="col-sm-8">
					<input class="form-control" type="number" id="pet_Age" name="pet_Age" value="${pet.pet_Age }">
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="gender-radio-group col-sm-8" id="pet_IsNeutralized">
					<input type="radio" name="pet_IsNeutralized" value="1" <c:if
						test="${pet.pet_IsNeutralized eq true}">checked="checked"</c:if>>
					<i class="far fa-circle"></i> <input type="radio" name="pet_IsNeutralized" value="0" <c:if
						test="${pet.pet_IsNeutralized eq false}">checked="checked"</c:if>>
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="number" class="form-control" id="pet_Weight" placeholder="kg" name="pet_Weight"
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" id="pet_History" name="pet_History"
						value="${pet.pet_History }">
				</div>
			</div>
