			...
			<div class="col-10 mx-auto main-block" style="text-align: left;">
               ...
               <form class="w-50 ml-auto mr-auto mt-5 mb-5" action="company_signupDo" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="Company_Password" placeholder="비밀번호" name="company_Password" required>
                </div>
                <div class="form-group">
                    <label for="Company_UserName">업주 이름</label>
                    <input type="text" class="form-control" id="Company_UserName" placeholder="업주 이름" name="company_UserName" required>
                </div>
                
                <div class="form-group">
                    <label for="Company_ResidentNumber">주민 등록 번호</label>
                    <input type="text" class="form-control" id="Company_ResidentNumber" placeholder="사업자 주민등록번호" name="company_ResidentNumber" required>
                </div>
                
                <div class="form-group">
                    <label for="Company_Address">업체 주소</label>
                    <input type="text" class="form-control" id="Company_Address" placeholder="업체 주소" name="company_Address" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Company_Name" placeholder="업체 이름" name="company_Name" required>
                </div>

                <div class="form-group">
                    <label for="Company_UserPhoneNumber">업체 전화번호</label>
                    <input type="text" class="form-control" id="Company_UserPhoneNumber" placeholder="업체 전화번호" name="company_UserPhoneNumber" required>
                </div>

                <div class="form-group">
                    <label for="Company_Number">사업자 번호</label>
                    <input type="text" class="form-control" id="Company_Number" placeholder="사업자 번호" name="company_Number" required>
