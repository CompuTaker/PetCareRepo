		...
		<form method="POST" action="reserve_ok" accept-charset="utf-8"
						...
						<table class="table table-hover">
							...
							<tbody>
								<c:forEach items="${companyList}" var="company">
									<c:if test="${company.company_Type eq '미용'}">
										<tr class="record">
			...
			<div class="form-group row my-5 font-weight-bold">
				...
				<script>
					...
					document.getElementById('Reservation_PType').setAttribute(
							'min', today);
				</script>
				<label class="col-sm-2 col-form-label font-weight-bold"
			...
			<div class="form-group row mt-5">
				<div class="form-check mx-auto ">
					<h4>개인정보의 수집 및 이용 동의서</h4>
					<p>이용자가 제공한 모든 정보는 다음의 목적을 위해 활용하며, 목적 이외의 용도로는 사용되지 않습니다.</p>
					<ol class="text-left ">
						<li>개인정보 수집 항목 - 성명(국문),주소, 전화번호, 사진, 이메일 등 항목에 기재된 정보 또는
								신청자가 제공한 정보
						</li>
						<li>개인정보 수집 이용 목적 - 사이트 이용 목적</li>
						<li>개인정보 보유 및 이용기간 - 수집·이용 동의일로부터 개인정보의 수집·이용목적을 달성할 때까지</li>
						<li>동의거부관리 - 귀하께서는 본 안내에 따른 개인정보 수집, 이용에 대하여 동의를 거부하실 권리가 있습니다. 단, 사이트 이용이 제한될 수 있습니다.</li>
					</ol>
