			...
			<div class="col-10 mx-auto main-block" style="text-align: left;">
               ...
               <form class="w-50 ml-auto mr-auto mt-5 mb-5" action="company_signupDo" method="post">
                ...
                <div class="form-group">
                    ...
                    <button id="checkCompanyId">중복확인</button>
...
$("#checkCompanyId").click(function() {
	...
	alert(company_Id);
	$.ajax({
		url : '${pageContext.request.contextPath}/company_checkComId?company_Id='+ company_Id,
		method : 'GET',
		async : false,
...
$("#checkCompanyNum").click(function() {
	var comapny_Number = $('#Comapny_Number').val();
	$.ajax({
		url : '${pageContext.request.contextPath}/company_checkComNum?comapny_Number='+ comapny_Number,
		method : 'GET',
		async : false,
		complete : function(data) {
			if (data.responseText == 1) {
