...
<div class="row mx-auto main-container">
  <div class="col-10 mx-auto main-block" style="text-align: left;">
    ...
    <form class="w-50 ml-auto mr-auto mt-5 mb-5" action="company_signupDo" method="post" enctype="multipart/form-data">
      <div class="mb-5">
        <img id="imageFile" src="#" style="width: 100px; height: 100px;"
          onerror='src="<c:url value="/resources/images/profile.png" />"' alt="image" />

        <input name="imageFile" type="file" onchange="readURL(this);" accept="image/*" />
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="Company_UserPhoneNumber" placeholder="업체 전화번호"
          name="company_UserPhoneNumber" required />
      </div>
...
<script type="text/javascript">
  ...
  $("#checkCompanyId").click(function () {
    ...
    $.ajax({
      url: '${pageContext.request.contextPath}/company_checkId?company_Id=' + company_Id,
      method: 'GET',
      async: false,
